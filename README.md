...
Procedemos como antes, a añadir el fichero "README.md" al repositorio local; al estar el fichero ya trackeado usamos el comando **git commit -am** + ('mensajeExplicativo'), así añadimos el fichero a "staging", comiteamos los cambios y escribimos el mensaje de "commit", todo con el mismo comando.
